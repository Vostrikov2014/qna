...
describe Ability, type: :model do
  ...
  describe 'for user' do
    ...
    it { should be_able_to :update,  create(:comment, commentable: create(:question, user: user), user: user) }
    it { should_not be_able_to :update, create(:comment, commentable: create(:question, user: user), user: other) }
    it { should be_able_to :update,  create(:comment, commentable: create(:answer, user: user), user: user) }
    it { should_not be_able_to :update, create(:comment, commentable: create(:answer, user: user), user: other) }
